...
public class GameFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSoundX = mSoundPool.load(getActivity(), R.raw.sound2, 1);
        mSoundO = mSoundPool.load(getActivity(), R.raw.sound3, 1);
        mSoundMiss = mSoundPool.load(getActivity(), R.raw.sound4, 1);
        mSoundRewind = mSoundPool.load(getActivity(), R.raw.sound5, 1);
    }
